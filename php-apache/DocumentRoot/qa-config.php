...
*/
	...
	define('QA_MYSQL_HOSTNAME', $_ENV['MYSQL_HOST'] );
	define('QA_MYSQL_USERNAME', $_ENV['MYSQL_USER']);
	define('QA_MYSQL_PASSWORD', $_ENV['MYSQL_PASSWORD']);
	define('QA_MYSQL_DATABASE', $_ENV['MYSQL_DATABASE']);
